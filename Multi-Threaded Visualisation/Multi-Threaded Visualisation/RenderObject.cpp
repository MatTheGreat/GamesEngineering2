...
RenderObject::RenderObject(SDL_Texture * texture, int sourceX, int sourceY, int sourceWidth, int sourceHeight, int destX, int destY, int destWidth, int destHeight)
{
	m_texture = texture;
